...
import CurrentUserButton from '@/components/ui/currentuser-button';
...
import type { ListMenuItem, NavigationItem } from '@/types/components.type';
  ...
  return (
    ...
    >
      <nav className="mx-auto flex w-full max-w-7xl items-center px-6 py-3 md:px-10 lg:px-16 xl:px-24">
        <Logo to="/" className="text-foreground flex-1 gap-3" />
