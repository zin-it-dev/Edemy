        ...
        <section className='flex flex-col md:flex-row items-center justify-center gap-10 max-md:px-4 pb-20'>
            ...
            <div className='text-sm max-w-lg'>
                ...
                <svg
                    ...
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                    className='inset-x-0 bottom-0 translate-y-1/2 max-sm:hidden'
                >
                    <path
                ...
                <p className='mt-8'>
                    PrebuiltUI helps you build faster by transforming your
                    design vision into fully functional, production-ready UI
                    components.{" "}
                </p>
                <p className='mt-4'>
                    Whether you're launching a SaaS app, landing page or
                    dashboard, our collection of Tailwind CSS components is
                    crafted to boost your development speed and improve user
                    experience.
                </p>
                <p className='mt-4'>
