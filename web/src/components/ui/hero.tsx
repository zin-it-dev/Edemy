...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
      {/* BACKGROUND IMAGE */}
      <img src={heroBg} className="absolute inset-0 -z-10 size-full opacity" />
      ...
      <h1 className="text-center text-4xl leading-12 md:text-6xl/70 md:leading-17.5 mt-6 font-semibold max-w-4xl px-4">
        Design & Launch Courses with{' '}
      ...
      <p className="text-center text-sm md:text-base max-w-lg mt-4 px-4 text-slate-200">
        Our platform helps you build, test, and deliver learn faster.
      </p>
