...
class SettingsBackend(BaseBackend):
    ...
    def authenticate(self, request, username=None, password=None):
        ...
        pwd_valid = check_password(password, make_password(settings.DEFAULT_PASSWORD))
    ...
    def has_perm(self, user_obj, perm, obj=None):
        return user_obj.username in settings.ADMINS
        ...
        try:
            ...
            user, _ = User.objects.get_or_create(
                ...
                defaults={
                    ...
                    or "-".join(
                        [email.email_address.split("@")[0], secrets.token_urlsafe(4)]
                    ),
